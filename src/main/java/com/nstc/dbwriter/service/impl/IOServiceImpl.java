...
public class IOServiceImpl implements IIOService {
    ...
    @Override
    public List<String> readToLine(String fileName) {
        return readToLine(new File(fileName));
    }
    ...
    @Override
    public void write(String fileName, List<String> lineList) {
            ...
            for (File file : files) {
                ...
                if(file.isDirectory()) {
                    ...
                    if(outName == null) {
                        ...
                        newFileName = Container.lineService.replaceTemplet(outName, table.getMap(), "table");
                        newFileName = Container.lineService.replaceTemplet(newFileName, CommonSettings.map, "common");
                    }
    ...
    public void writeCommonFileByTemplet(Table table) {
        ...
        resultList = Container.lineService.buildNewLine(lineList, table);
    ...
    public void writeFileByTemplet(File templet, File outFile, Table table) {
        ...
        List<String> resultList = Container.lineService.buildNewLine(lineList, table);
    ...
    public void writeDataFile(Table table) {
        ...
        try {
            ...
            List<List<Object>> dataList = Container.databaseService.getDateBySql(sql);
